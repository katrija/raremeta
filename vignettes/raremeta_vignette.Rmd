...
We begin by exploring the data a little bit.
After that, we will be fitting statistical models by using the functions which are 
part of the `raremeta` package.
We will put emphasis on the input's syntax and interpretation of the output.
At the end, there will be a section discussing pre processing of the input data.
...
As seen above, the Yuan data is in fact a data frame of rare events.
...
The Yuan data set includes double zero studies, making it a good example for presenting the usage of the implemented techniques from meta analysis of rare events included in `raremeta`.  

We continue by presenting the following functions one by one.
