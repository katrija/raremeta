...
rareIV(x,ai,bi,ci,di,n1i,n2i,data,
       measure,method,cc="none",ccval=0.5,tccval,cccval,ccsum=1,ccto="only0",drop00=TRUE,weighted=TRUE,weights,level=95,test="z",digits=4,verbose=FALSE,control,...)
```
...
The arguments `cc` to `ccto` define the type of continuity correction applied to the data before the analysis and the argument `drop00` specifies whether double zero studies shall be excluded from the analysis.  
